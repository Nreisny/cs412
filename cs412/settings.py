...
SECRET_KEY = 'django-insecure-bhfres@hk(1h5e#&09n*i-5j=gd7+^7nm48c(#v##k2am5@o1o'
...
INSTALLED_APPS = [
    ...
    'quotes', # New HW app added
    'formdata', # New app example added
